<template>
	<div class="section no-pad-bot" id="index-banner">
		<div class="container-fluid">
			<br><br>
			<h1 class="header center orange-text">AKa Mart</h1>
			<div class="row center">
				<h5 class="header col s12 light">Semua Ada Di Sini</h5>
			</div>
			<br><br>
				...
				<div class="col offset-m8 m4">
					<div class="input-field col s12">
						<select v-on:change="onchangeSortBy">
							<option value="newestToOldest">Terbaru Hingga Terlama</option>
							<option value="oldestToNewest">Terlama Hingga Terbaru</option>
							<option value="priceDescending">Harga (Turun)</option>
							<option value="priceAscending">Harga (Naik)</option>
						</select>
						<label>Sort by</label>
					</div>
				</div>
						...
						<div class="col m4" v-for="(product) in products" v-bind:key="product._id">
							<div class="card blue-grey darken-1">
								<div class="card-content white-text">
									...
									<p>Rp<span v-text="product.price"></span></p>
								</div>
